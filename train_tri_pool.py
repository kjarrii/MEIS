...
class SpatialBinaryNet(nn.Module):
...
class Trainer:
    ...
    def _prepare(self):
        ...
        self.model = SpatialBinaryNet(dataset.channels, dataset.height, dataset.width, self.config).to(self.device)
